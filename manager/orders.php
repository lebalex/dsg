...
<table className="table table-hover" >
  ...
  <tbody>
          ...
          {items.map((item, index) => (
            <tr key={index} className={(item.exec==0)?'table-light':'table-primary'} onClick={() => this.openOrder( item.id, item.exec, item.name, item.phone, item.email )}>
